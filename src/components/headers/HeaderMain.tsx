...
const HeaderMain = () => {
    ...
    return (
        <div className={"bg-headerColor w-full h-20 flex justify-between items-center px-3 border-b border-gray-300"}>
            ...
            <SearchBar/>
            <div className={""}>
                <LoginSignButton openModal={openModal} text={"Login"} textColor={"text-black"} bgColor={"bg-gray-50"}
                                 hoverColor={"hover:bg-gray-200"}/>
                <LoginSignButton openModal={openModal} text={"Sign Up"} textColor={"text-white"}
                                 bgColor={"bg-caribCurrent"}/>
            </div>
            <LoginModal showModal={isModalOpened} closeModal={closeModal}>
                {/*Header*/}
                <div
